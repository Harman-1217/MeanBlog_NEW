var express = require('express'),
        ...
        chitchat = require('./models/chitchat'),
    // nodemailer modules
...
module.exports = function(app, passport) {
    ...
    require('./api/chitchat')(apiRouter);
    ...
    router.get('/testimonials',function(req, res) {
     ...
     router.get('/chitchat',function(req, res) {
        res.render('home/chitchat');
    });
...
function isAdmin(req, res, next) {
    if (req.isAuthenticated() && req.user.email === 'abc@gmail.com') {
