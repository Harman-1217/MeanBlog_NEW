...
* Add chitchat
*/
 adminApp.controller('addchitchatCtrl', function($scope,chitchat) {
$scope.post={};
  $scope.addPost = function() {
        console.log(this.post);
        $scope.newPost = {};
       $scope.newPost.name = this.post.name;
        ...
        chitchat.add($scope.newPost).then(function(res) {
            console.log(res);
            // console.log('ashu')
        });
         this.post = {};
...
// * 
// */
 adminApp.controller('chitchatListCtrl', function($scope,chitchatList,chitchat) {
    console.log('heyyoo');
     $scope.posts = chitchatList;
    $scope.activePost = false;
    $scope.setActive = function(user) {
        $scope.activePost = user;
        console.log($scope.activePost);
    ...
    $scope.deletepost = function(id) {
        $scope.data={};
         $scope.data.id=id;
        // console.log($scope.data);
        chitchat.remove($scope.data).then(function(res) {
            console.log(res);
            if (res) {
                alert(res.message);
                window.location.reload();
